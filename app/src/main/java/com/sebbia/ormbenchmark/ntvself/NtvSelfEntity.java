...
public class NtvSelfEntity implements BenchmarkEntity {

    public static NtvSelfEntity fromCursor(Cursor cursor) {
        NtvSelfEntity noOrmEntity = new NtvSelfEntity();
