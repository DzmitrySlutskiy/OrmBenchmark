...
public class NtvStrEntity implements BenchmarkEntity {

    public static com.sebbia.ormbenchmark.ntvstr.NtvStrEntity fromCursor(Cursor cursor) {
        com.sebbia.ormbenchmark.ntvstr.NtvStrEntity noOrmEntity = new com.sebbia.ormbenchmark.ntvstr.NtvStrEntity();
